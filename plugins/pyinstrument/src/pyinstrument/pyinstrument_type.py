...
from .pyinstrument_object import PyinstrumentObject

# Create a custom message stream to send messages to the client


class PyinstrumentMessageStream(MessageStream):
    """
    ...
    def __init__(self, obj: Any, client_connection: MessageStream):
        ...
        # These additional messages are processed in PyinstrumentView.tsx
...
# The value returned by name() should match supportedTypes in PyinstrumentPlugin.ts
class PyinstrumentType(BidirectionalObjectType):
    """
    ...
    def name(self) -> str:
        ...
        """
        # this name should match the supportedTypes in PyinstrumentPlugin.ts
        return "Pyinstrument"
    ...
    def is_type(self, obj: Any) -> bool:
        ...
        return isinstance(obj, PyinstrumentObject)
    ...
    def create_client_connection(
        ...
        message_stream = PyinstrumentMessageStream(obj, connection)
