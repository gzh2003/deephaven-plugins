...
const log = Log.module('pyinstrument.PyinstrumentView');

// Create a custom style for the component
export const PyinstrumentViewStyle: CSSProperties = {
...
export function PyinstrumentView(props: WidgetComponentProps): JSX.Element {
  const { fetch } = props;
  ...
  return (
    <div style={PyinstrumentViewStyle}>
      <div>{text}</div>
